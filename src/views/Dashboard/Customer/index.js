...
function Customer() {
    ...
    const onDelete = (id) => {
        ...
        setLoading(true);
        // axios delete
        axios.delete(`https://kel6nitipmotorapi.franciscusrangga.com/api/v1/customer/${id}`, {
            headers: {
        ...
        <Flex direction='column' pt={{ base: "120px", md: "75px" }}>
            <Card overflowX={{ sm: "scroll", xl: "hidden" }}>
                <CardHeader p='6px 0px 22px 0px'>
                    <Button onClick={() => navigate.push('/admin/addcustomer')}
                    ...
                    <Table variant='simple' color={textColor}>
                        <Thead>
                            <Tr my='.8rem' pl='0px' color='gray.400'>
                                {["Nama Customer", "No Telepon", "Aksi"].map((caption, idx) => {
                                    return (
